      ...
      <div className="container py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold dark:text-white mb-4">Property Details</h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="dark:text-white">{property.parkingSpaces} Parking</span>
                </div>
                <div className="flex items-center space-x-2">
                  <FiMaximize2 className="text-primary-600 dark:text-primary-400" />
                  <span className="dark:text-white">{property.lotSize}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <FiCalendar className="text-primary-600 dark:text-primary-400" />
                  <span className="dark:text-white">Built {property.yearBuilt}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <FiUsers className="text-primary-600 dark:text-primary-400" />
                  <span className="dark:text-white">{property.metrics.totalInvestors} Investors</span>
                </div>
              </div>

              <h3 className="text-xl font-semibold dark:text-white mb-4">Features</h3>
              ...
              {/* Token Details */}
              <h3 className="text-xl font-semibold dark:text-white mb-4">Token Information</h3>
              ...
              {/* Financial Details */}
              <h3 className="text-xl font-semibold dark:text-white mb-4">Financial Overview</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-6">
                  <h4 className="font-semibold dark:text-white mb-4">Rental Income</h4>
                ...
                <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-6">
                  <h4 className="font-semibold dark:text-white mb-4">Expenses</h4>
                  <div className="space-y-2">
              ...
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-2xl font-bold dark:text-white">${property.price.usd.toLocaleString()}</span>
                  </div>
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-md p-6">
              ...
              <div className="space-y-2">
                <p className="text-sm dark:text-secondary-300">
                  <span className="font-medium dark:text-white">Phone:</span> {property.agent.phone}
                </p>
                <p className="text-sm dark:text-secondary-300">
                  <span className="font-medium dark:text-white">Email:</span> {property.agent.email}
                </p>
              </div>
